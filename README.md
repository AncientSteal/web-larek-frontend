...
[Посмотреть проект Web-ларёк.](https://github.com/AncientSteal/web-larek-frontend/tree/main)
## Оглавление
- [Описание](#описание)
...
Перед установкой и запуском проекта необходимо проверить наличие файла .env с адресом сервера `API_ORIGIN`
